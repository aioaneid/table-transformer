...
def compute_border_boxes(outer_border, hole_border, xlim, ylim):
    return [
...
def plot_boxes(
    ...
    plot_rectangles(
        ...
        b,
        frame,
        "../../work/saved/plots/random_{}_{}.svg".format(label, function_name),
    )
    ...
    plot_rectangles(
        ...
        b,
        frame,
        "../../work/saved/plots/concentric_{}_{}.svg".format(label, function_name),
    )
...
def draw_plots():
    ...
    b[1::2] *= stretch_y
    n = 4
    # n=4: mv ../../work/saved/plots ~/work/saved/plots_few
    # n=12: mv ../../work/saved/plots ~/work/saved/plots
    upsample = 5000
